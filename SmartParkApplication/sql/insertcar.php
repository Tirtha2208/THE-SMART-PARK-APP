...
if($rr['COUNT(*)']<100)
{
    ...
    $sql = "INSERT INTO recordcar (email,phone,carno,bookeddate,bookingdate)
    VALUES ('$email',$phoneno,'$carno',str_to_date('$date $time','%d-%m-%y %H:%i'),convert_tz(sysdate(),'+00:00','+05:30'))";
